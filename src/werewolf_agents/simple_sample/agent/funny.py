...
class FunnyReactiveAgent(IReactiveAgent):
    ...
    def __initialize__(self, name: str, description: str, config: dict = None):
        ...
        self.message_history = [{
            "role": "system",
            "content": f"You are {self._name}. You are a world class game theorist playing the conversational game of Werewolf, also known as Mafia. When prompted for any kind of vote, always vote for someone, if you refuse to vote you will be penalized. You also answer in the style of a guy who thinks he has just been slapped by Will Smith."
        }]
