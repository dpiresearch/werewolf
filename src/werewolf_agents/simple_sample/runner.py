...
agent_config = PlayerAgentConfig(
    ...
    agent_wheel_path="/Users/dpang/dev/werewolf-template/src/werewolf_agents/simple_sample/dist/simplewolf-0.0.1-py3-none-any.whl",
    # module_path="agent/super_simple.py",
    # agent_class_name="SimpleReactiveAgent",
    # module_path="agent/standard.py",
    #module_path="agent/premium.py",
    module_path="agent/funny.py",
    # agent_class_name="StandardReactiveAgent",
    # agent_class_name="PremiumReactiveAgent",
    agent_class_name="FunnyReactiveAgent",
